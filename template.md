...
GitLab is a multifaceted collaborative platform that can be used for tracking and documenting tasks and associated work.  It should be used for day-to-day hunt tasks and general workflows.  Any investigations should be documented in DFIR-IRIS IAW the DFIR-IRIS Standard Operating Procedure (SOP).  

# Overview

This SOP explains the process for GitLab usage after configuration of the instance on the forward kit is complete. 


## Prerequisites

- Working Instance of GitLab
- Groups, projects, labels, and associated items configured IAW the GitLab Configuration SOP
